...
//        ConsoleAppender consoleAppender = new ConsoleAppender();
        ...
        //设置文件名
        appender.setFile(OptionHelper.substVars(springLogbackPath + name + "/" + format.format(new Date()) + "/" + level.levelStr + ".log", context));
        ...
        //文件名格式
        String fp = OptionHelper.substVars(springLogbackPath + name + "/" + format.format(new Date()) + "/" + level.levelStr + "/.%d{yyyy-MM-dd}.%i.log", context);
        //最大日志文件大小
