package com.springboot.Utils.encrypt.AES;
...
public class AESEncryptUtils {
    ...
    public static void main(String[] args) {
         ...
         * 加密
         */
        String encodeRules = createSecretKey();
        System.out.println("使用AES对称加密，规则："+encodeRules);
        ...
        System.out.println("请输入要解密的内容（密文）:" + data);
        System.out.println("根据输入的规则" + encodeRules + "解密后的明文是:" + AESDncode(encodeRules, data));
    }
